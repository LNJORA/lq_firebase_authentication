...
fun UpdateProductScreen(navController: NavHostController,id:String) {
    Column(modifier = Modifier.fillMaxSize(),
        ...
        Button(onClick = {
            ...
            var ProductViewModels = ProductViewModels(navController, context)
          ProductViewModels.updateProduct(productName.text.trim(),productQuantity.text.trim(),
